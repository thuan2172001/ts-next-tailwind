      ...
      <div className='px-4 mx-auto max-w-7xl sm:px-6'>
        <div className='flex justify-between items-center py-6 border-b-2 border-gray-100 md:justify-start md:space-x-10'>
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      'group inline-flex items-center text-base font-medium bg-white rounded-md hover:text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none'
                    )}
                  >
                    <span>Solutions</span>
                    <ChevronDownIcon
                      className={classNames(
                        ...
                        'ml-2 w-5 h-5 group-hover:text-gray-500'
                      )}
                      aria-hidden='true'
                    />
                  </Popover.Button>
                  ...
                  >
                    <Popover.Panel className='absolute z-10 px-2 mt-3 -ml-4 w-screen max-w-md transform sm:px-0 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2'>
                      <div className='overflow-hidden rounded-lg ring-1 ring-black ring-opacity-5 shadow-lg'>
                        ...
                        <div className='px-5 py-5 space-y-6 bg-gray-50 sm:flex sm:px-8 sm:space-x-10 sm:space-y-0'>
              ...
              {({ open }) => (
                <>
                  ...
                  <Transition
                    ...
                    leaveTo='opacity-0 translate-y-1'
                  >
                    <Popover.Panel className='absolute left-1/2 z-10 px-2 mt-3 w-screen max-w-md transform -translate-x-1/2 sm:px-0'>
                      <div className='overflow-hidden rounded-lg ring-1 ring-black ring-opacity-5 shadow-lg'>
                        <div className='grid relative gap-6 px-5 py-6 bg-white sm:gap-8 sm:p-8'>
                          {resources.map((item) => (
                            <a
          ...
          <div className='hidden justify-end items-center md:flex md:flex-1 lg:w-0'>
            ...
            <a
              href='#'
              className='inline-flex justify-center items-center px-4 py-2 ml-8 text-base font-medium text-white whitespace-nowrap bg-indigo-600 rounded-md border border-transparent shadow-sm hover:bg-indigo-700'
            >
              Sign up
            </a>
          </div>
          ...
          <div className='bg-white rounded-lg divide-y-2 divide-gray-50 ring-1 ring-black ring-opacity-5 shadow-lg'>
            ...
            <div className='px-5 py-6 space-y-6'>
              ...
              <div>
                <a
                  href='#'
                  className='flex justify-center items-center px-4 py-2 w-full text-base font-medium text-white bg-indigo-600 rounded-md border border-transparent shadow-sm hover:bg-indigo-700'
                >
                  Sign up
                </a>
